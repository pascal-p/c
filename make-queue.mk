...
SRC1      = $(.CURDIR)/lib/queue.c
OBJ1      = $(.CURDIR)/obj/queue.o 
INC      += $(.CURDIR)/inc/queue.h
OBJS     += $(OBJ1)

SRC2      = $(.CURDIR)/lib/sllist.c
OBJ2      = $(.CURDIR)/obj/sllist.o 
INC      += $(.CURDIR)/inc/sllist.h
OBJS     += $(OBJ2)

SRC3      = $(.CURDIR)/lib/my_malloc.c
OBJ3      = $(.CURDIR)/obj/my_malloc.o 
